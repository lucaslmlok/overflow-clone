      ...
      <main>
        <div className="container">
          <section className="text-center">
            ...
            <p>
              Create beautiful user flows and design presentations to narrate
              your design story like never before.
            </p>
            ...
            >
              <div className="my-20">
                ...
                <p>
                  ...
                  user journey, navigate through it effortlessly, and
                  communicate your work effectively to your team and
                  stakeholders.
                </p>
              </div>
              <div className="my-20">
                ...
                <p>
                  Create professional design presentations to engage your
                  audience in design critique. Use only the screens you want to
                  share, organize and group them efficiently, and add additional
                  content or branding cues for a seamless presentation
                  experience.
                </p>
              </div>
              <div className="flex flex-col items-center gap-9 px-16 py-10">
                ...
                <p className="mt-0 text-center leading-snug text-gray-400">
                  Trusted by more than 500,000 designers and product managers
                  across the globe
                </p>
              </div>
            </IconContext.Provider>
          ...
          <section>
            ...
            <p>
              ...
              impactful design presentations together. Organize your documents
              and publications in private or shared folders, depending on your
              team's security needs.
            </p>
          ...
          <section>
            ...
            <p>
              ...
              meetings with Overflow's interactive presentation features.
              Navigate between screens with ease using your mouse or keyboard.
              Zoom out for a bird's eye view of the user journey as a whole or
              switch to a rapid prototype view to focus on design details.
            </p>
            <ArrowLink href="/">See how</ArrowLink>
